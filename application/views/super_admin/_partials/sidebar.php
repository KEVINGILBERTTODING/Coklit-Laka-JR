<aside class="sidenav sidenavbar bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
	<div class="sidenav-header">
		...
		<a class="navbar-brand m-0" href="<?php echo base_url('superadmin') ?>">
			<img src="<?php echo base_url(); ?>assets/assets/img/logo_jr.png" class="navbar-brand-img h-100" alt="main_logo">
			<span class="ms-1 font-weight-bold">ADISTI</span>
		</a>
	</div>
	...
	<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
		<ul class="navbar-nav">
			...
			<li class="nav-item ">
				<a class="nav-link  <?php echo $this->uri->segment(2) == 'dashboard' ? 'active' : '' ?>" href="<?php echo site_url('super_admin/dashboard') ?>">
			...
			<li class="nav-item  ">
				<a class="nav-link <?php echo $this->uri->segment(2) == 'user' ? 'active' : '' ?> " href="<?php echo site_url('super_admin/user') ?>">
					<div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
			...
			<li class="nav-item  ">
				<a class="nav-link <?php echo $this->uri->segment(2) == 'profile' ? 'active' : '' ?> " href="<?php echo site_url('super_admin/profile') ?>">
					<div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
