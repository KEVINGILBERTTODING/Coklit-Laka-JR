<aside class="sidenav sidenavbar bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
	<div class="sidenav-header">
		...
		<a class="navbar-brand m-0" href="<?php echo base_url('pelihat') ?>">
			<img src="<?php echo base_url(); ?>assets/assets/img/logo_jr.png" class="navbar-brand-img h-100" alt="main_logo">
			<span class="ms-1 font-weight-bold">JATENG</span>
		</a>
	</div>
	...
	<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
		<ul class="navbar-nav">
			...
			<li class="nav-item ">
				<a class="nav-link  <?php echo $this->uri->segment(2) == 'dashboard' ? 'active' : '' ?>" href="<?php echo site_url('pelihat/dashboard') ?>">
			...
			<li class="nav-item  ">
				<a class="nav-link <?php echo $this->uri->segment(2) == 'realisasi' ? 'active' : '' ?> " href="<?php echo site_url('admin/realisasi') ?>">
					...
					<span class="nav-link-text ms-1">Monitoring SW</span>
				</a>
			</li>
			...
			<li class="nav-item  ">
				<a class="nav-link <?php echo $this->uri->segment(2) == 'lpj' ? 'active' : '' ?> " href="<?php echo site_url('admin/lpj') ?>">
					...
					<span class="nav-link-text ms-1">Monitoring IW</span>
				</a>
			</li>
			...
			<li class="nav-item  ">
				<a class="nav-link <?php echo $this->uri->segment(2) == 'profile' ? 'active' : '' ?> " href="<?php echo site_url('pelihat/profile') ?>">
					<div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
